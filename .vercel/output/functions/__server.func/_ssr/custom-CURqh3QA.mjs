...
function Custom() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-6 md:px-10 py-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-4", children: [
      "Send any raw BLE protocol string, or use these common recipe setup shortcuts. Examples: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid md:grid-cols-2 gap-4", children: [{
      t: "Induction recipe step",
      d: "Tune base heat for searing, frying and pan-contact cooking."
    }, {
      t: "Microwave recipe step",
      d: "Add top energy for fast internal heating and moisture-controlled cooking."
    }, {
      t: "Stirrer profile",
      d: "Select LOW, MED, HIGH or VERY HIGH based on recipe viscosity."
    }, {
      t: "Pump dosing",
      d: "Trigger water addition by ticks for recipes needing controlled moisture."
    }].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-border p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg", children: item.t }),
